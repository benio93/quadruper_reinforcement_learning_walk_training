...
class RhythmWalkEnv(QuadEnv):
    ...
    def step(self, action):
        ...
        tremble_penalty = 3.0 if max_delta < 0.1 else 0.0
        strong_kick_bonus = 4.0 if max_delta > 0.25 else 0.0
